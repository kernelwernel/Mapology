...
# BibTeX
```bibtex
@misc{jeanruyvacelet2026okinawa,
  author       = {Jean-Ruy Vacelet},
  title        = {Map of {U.S.} Military Bases in Okinawa},
  year         = {2026},
  howpublished = {\url{https://github.com/kernelwernel/Mapology/tree/main/Okinawa-US-Military}},
  note         = {Dataset and cartographic work}
}
```
